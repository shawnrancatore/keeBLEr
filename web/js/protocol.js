...
// WiFi management
export const TYPE_WIFI_SCAN_REQ        = 0x40;
export const TYPE_WIFI_SCAN_RESULT     = 0x41;
export const TYPE_WIFI_SCAN_DONE       = 0x42;
export const TYPE_WIFI_CONNECT_REQ     = 0x43;
export const TYPE_WIFI_STATUS          = 0x44;
export const TYPE_WIFI_DISCONNECT_REQ  = 0x45;
export const TYPE_WIFI_TOKEN_VALIDATE  = 0x46;
export const TYPE_WIFI_TOKEN_RESPONSE  = 0x47;
export const TYPE_WIFI_FORGET_REQ      = 0x48;
export const TYPE_WIFI_AP_START        = 0x49;
export const TYPE_WIFI_AP_EVENT        = 0x4A;

// HTTP proxy
export const TYPE_HTTP_REQUEST         = 0x50;
export const TYPE_HTTP_REQUEST_HEADER  = 0x51;
export const TYPE_HTTP_REQUEST_BODY    = 0x52;
export const TYPE_HTTP_REQUEST_END     = 0x53;
export const TYPE_HTTP_RESPONSE_STATUS = 0x54;
export const TYPE_HTTP_RESPONSE_BODY   = 0x55;
export const TYPE_HTTP_RESPONSE_DONE   = 0x56;
export const TYPE_HTTP_REQUEST_URL_CONT = 0x57;
export const TYPE_HTTP_ERROR           = 0x58;
...
export const TYPE_NAMES = {
  ...
  [TYPE_ACK]:             'ACK',
  [TYPE_ECHO]:            'ECHO',
  [TYPE_WIFI_SCAN_REQ]:        'WIFI_SCAN_REQ',
  [TYPE_WIFI_SCAN_RESULT]:     'WIFI_SCAN_RESULT',
  [TYPE_WIFI_SCAN_DONE]:       'WIFI_SCAN_DONE',
  [TYPE_WIFI_CONNECT_REQ]:     'WIFI_CONNECT_REQ',
  [TYPE_WIFI_STATUS]:          'WIFI_STATUS',
  [TYPE_WIFI_DISCONNECT_REQ]:  'WIFI_DISCONNECT_REQ',
  [TYPE_WIFI_TOKEN_VALIDATE]:  'WIFI_TOKEN_VALIDATE',
  [TYPE_WIFI_TOKEN_RESPONSE]:  'WIFI_TOKEN_RESPONSE',
  [TYPE_WIFI_FORGET_REQ]:      'WIFI_FORGET_REQ',
  [TYPE_WIFI_AP_START]:        'WIFI_AP_START',
  [TYPE_WIFI_AP_EVENT]:        'WIFI_AP_EVENT',
  [TYPE_HTTP_REQUEST]:         'HTTP_REQUEST',
  [TYPE_HTTP_REQUEST_HEADER]:  'HTTP_REQUEST_HEADER',
  [TYPE_HTTP_REQUEST_BODY]:    'HTTP_REQUEST_BODY',
  [TYPE_HTTP_REQUEST_END]:     'HTTP_REQUEST_END',
  [TYPE_HTTP_RESPONSE_STATUS]: 'HTTP_RESPONSE_STATUS',
  [TYPE_HTTP_RESPONSE_BODY]:   'HTTP_RESPONSE_BODY',
  [TYPE_HTTP_RESPONSE_DONE]:   'HTTP_RESPONSE_DONE',
  [TYPE_HTTP_REQUEST_URL_CONT]: 'HTTP_REQUEST_URL_CONT',
